...
![](/imgs/customer_address.png)

在UML类图中单向关联用一个带  箭头的实线表示。上图表示每个顾客都有一个地址，这通过让Customer类持有一个类型为Address的成员变量类实现。

**2，双向关联**

![](/imgs/customer_product.png)
...
![](/imgs/image-20191229173422328.png)
...
![](/imgs/image-20191229173455149.png)
...
![](/imgs/image-20191229173518926.png)
...
![](/imgs/image-20191229173539838.png)
...
![](/imgs/image-20191229173554296.png)
...
<img src="/imgs/正方形不是长方形改进.png" style="zoom:80%;" />
...
<img src="/imgs/依赖倒转原则.png" style="zoom:80%;" />
...
<img src="/imgs/依赖倒转原则改进.png" alt="image-20191229173554296" style="zoom:70%;" />
...
<img src="/imgs/迪米特法则.png" alt="image-20191229173554296" style="zoom:80%;" />
...
<img src="/imgs/合成复用原则.png" alt="image-20191229173554296" style="zoom:80%;" />

从上面类图我们可以看到使用继承复用产生了很多子类，如果现在又有新的动力源或者新的颜色的话，就需要再定义新的类。我们试着将继承复用改为聚合复用看一下。

<img src="/imgs/合成复用原则1.png" alt="image-20191229173554296" style="zoom:80%;" />
...
<img src="/imgs/工厂设计模式引入.png" style="zoom:80%;" />
...
<img src="/imgs/简单工厂模式.png" style="zoom:70%;" />
...
<img src="/imgs/工厂方法模式.png" style="zoom:70%;" />
...
<img src="/imgs/image-20200401214509176.png" style="zoom:67%;" />

<img src="/imgs/image-20200401222951963.png" style="zoom:67%;" />
...
<img src="/imgs/抽象工厂模式.png" style="zoom:67%;" />
...
<img title="" src="/imgs/JDK源码解析.png" alt="" style="zoom:75%;">
...
<img src="/imgs/原型模式1.png" style="zoom:80%;" />
...
<img src="/imgs/原型模式2.png" style="zoom:80%;" />
...
<img src="/imgs/原型模式3.png" style="zoom:80%;" />
...
<img src="/imgs/image-20200413225341516.png" style="zoom:60%;" />
...
<img src="/imgs/建造者模式.png" style="zoom:80%;" />
...
<img src="/imgs/建造者模式1.png" style="zoom:80%;" />
...
Java中的代理按照代理类生成时机不同又分为静态代理和动态代理。静态代理代理类在<mark>编译</mark>期就生成，而动态代理代理类则是在Java<mark>运行时动态生成</mark>。动态代理又有JDK代理和CGLib代理两种。
...
<img src="/imgs/静态代理.png" style="zoom:80%;" />
...
* ProxyFactor y是代理类吗？
  ...
  * 代理类（$Proxy0）实现了SellTickets。这也就印证了我们之前说的真实类和代理类<mark>实现同样的接口</mark>。
...
[035-第十二讲-jdk代理原理_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1P44y1N7QG?p=36&spm_id_from=pageDriver&vd_source=287680e91dcebf5883fc989d2b40edbf)
...
<img src="/imgs/适配器模式.png" style="zoom:80%;" />
...
<img src="/imgs/对象适配器模式.png" style="zoom:80%;" />
...
<img title="" src=".//imgs/装饰者模式-使用前.png" alt="" style="zoom:80%;">
...
<img src="/imgs/装饰者模式.png" style="zoom:75%;" />
...
<img src="/imgs/装饰者模式-jdk源码.png" style="zoom:80%;" />
...
<img src="/imgs/桥接模式.png" style="zoom:80%;" />
...
<img src="/imgs/外观模式.png" style="zoom:80%;" />
...
<img title="" src="/imgs/image3-1.png" alt="" style="zoom:60%;">

RequestFacade类就使用了外观模式。先看结构图：

<img src="/imgs/外观模式-jdk源码解析.png" style="zoom:70%;" />
...
<img title="" src="/imgs/image4-1.png" alt="" style="zoom:60%;">
...
<img title="" src="/imgs/image4-2.png" alt="" style="zoom:80%;">

要实现该案例，我们先画出类图：

<img src="/imgs/组合模式.png" style="zoom:80%;" />
...
* 安全组合模式
  ...
  <img src="/imgs/组合模式-安全性.png" style="zoom:80%;" />
...
<img src="/imgs/俄罗斯方块.jpeg" style="zoom:60%;" />

**先来看类图：**

<img src="/imgs/享元模式.png" style="zoom:80%;" />
...
<img src="/imgs/image-20200208212930857.png" style="zoom:80%;" />
...
<img src="/imgs/模板方法模式.png" style="zoom:80%;" />
...
<img src="/imgs/image-20200210143039168.png" style="zoom:80%;" />

作为一个程序猿，开发需要选择一款开发工具，当然可以进行代码开发的工具有很多，可以选择Idea进行开发，也可以使用eclipse进行开发，也可以使用其他的一些开发工具。

<img src="/imgs/image-20200210144457478.png" style="zoom:70%;" />
...
<img src="/imgs/策略模式.png" style="zoom:80%;" />
...
<img src="/imgs/image-20200211130313251.png" style="zoom:60%;" />
...
<img src="/imgs/命令模式.png" style="zoom:75%;" />
...
<img src="/imgs/责任链模式.png" style="zoom:80%;" />
...
<img src="/imgs/状态模式前.png" style="zoom:80%;" />
...
<img src="/imgs/状态模式.png" style="zoom:70%;" />
...
<img src="/imgs/观察者模式.png" style="zoom:80%;" />
...
<img src="/imgs/image-20200214110924010.png" style="zoom:60%;" />
...
<img src="/imgs/中介者模式.png" style="zoom:70%;" />
...
<img src="/imgs/迭代器模式.png" style="zoom:90%;" />
...
<img src="/imgs/image-20200214215446638.png" style="zoom:70%;" />
...
<img src="/imgs/image-20200426233931693.png" style="zoom:67%;" />
...
<img src="/imgs/白箱备忘录模式.png" style="zoom:80%;" />
...
<img src="/imgs/黑箱备忘录模式.png" style="zoom:70%;" />
...
<img src="/imgs/image-20200215220322641.png" style="zoom:60%;" />
...
<img src="/imgs/image-20200215225227616.png" style="zoom:50%;" />
...
<img src="/imgs/解释器模式.png" style="zoom:80%;" />
...
* 编写配置文件。在类路径下编写一个名为ApplicationContext.xml的配置文件
  ...
  <img src="/imgs/image-20200429165544151.png" style="zoom:60%;" />
...
<img src="/imgs/image-20200429111324770.png" style="zoom:40%;" />
...
<img src="/imgs/image-20200429185050396.png" style="zoom:60%;" />
...
<img src="/imgs/image-20200430220155371.png" style="zoom:60%;" />
...
<img src="/imgs/image-20200429204239868.png" style="zoom:60%;" />

### 7.3.3 BeanDefinitionReader解析

Bean的解析过程非常复杂，功能被分得很细，因为这里需要被扩展的地方很多，必须保证足够的灵活性，以应对可能的变化。Bean的解析主要就是对Spring配置文件的解析。这个解析过程主要通过BeanDefinitionReader来完成，看看Spring中BeanDefinitionReader的类结构图，如下图所示。

<img src="/imgs/image-20200429204700956.png" style="zoom:60%;" />
...
<img src="/imgs/image-20200429211132185.png" style="zoom:60%;" />
